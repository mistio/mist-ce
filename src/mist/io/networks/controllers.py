class NetworkController(object):
    ...
    def create_network(self, **network_args):
        """ Used by Network.add to trigger network creation using the cloud's Network controller."""
    ...
    def list_subnets(self):
        """ Returns the DB objects for all subnets attached to this network, if any."""
...
class SubnetController(object):
    ...
    def create_subnet(self, **subnet_args):
        """ Used by Subnet.add to trigger subnet creation using the cloud's Network controller."""
