  ...
  return function (callback) {
    if (!JS_BUILD) {
      require([
        ...
        Ember.TEMPLATES['image_list_item/html'] = Ember.Handlebars.compile(arguments[11]);
        Ember.TEMPLATES['key/html'] = Ember.Handlebars.compile(arguments[12]);
        Ember.TEMPLATES['key_add/html'] = Ember.Handlebars.compile(arguments[13]);
        Ember.TEMPLATES['key_edit/html'] = Ember.Handlebars.compile(arguments[14]);
        Ember.TEMPLATES['key_list/html'] = Ember.Handlebars.compile(arguments[15]);
        Ember.TEMPLATES['key_list_item/html'] = Ember.Handlebars.compile(arguments[16]);
        Ember.TEMPLATES['login/html'] = Ember.Handlebars.compile(arguments[17]);
        Ember.TEMPLATES['machine/html'] = Ember.Handlebars.compile(arguments[18]);
        Ember.TEMPLATES['machine_add/html'] = Ember.Handlebars.compile(arguments[19]);
        Ember.TEMPLATES['machine_keys/html'] = Ember.Handlebars.compile(arguments[20]);
        Ember.TEMPLATES['machine_keys_list_item/html'] = Ember.Handlebars.compile(arguments[21]);
        Ember.TEMPLATES['machine_list/html'] = Ember.Handlebars.compile(arguments[22]);
        Ember.TEMPLATES['machine_list_item/html'] = Ember.Handlebars.compile(arguments[23]);
        Ember.TEMPLATES['machine_manual_monitoring/html'] = Ember.Handlebars.compile(arguments[24]);
        Ember.TEMPLATES['machine_power/html'] = Ember.Handlebars.compile(arguments[25]);
        Ember.TEMPLATES['machine_shell/html'] = Ember.Handlebars.compile(arguments[26]);
        Ember.TEMPLATES['machine_shell_list_item/html'] = Ember.Handlebars.compile(arguments[27]);
        Ember.TEMPLATES['machine_tags/html'] = Ember.Handlebars.compile(arguments[28]);
        Ember.TEMPLATES['machine_tags_list_item/html'] = Ember.Handlebars.compile(arguments[29]);
        Ember.TEMPLATES['messagebox/html'] = Ember.Handlebars.compile(arguments[30]);
        Ember.TEMPLATES['metric_add/html'] = Ember.Handlebars.compile(arguments[31]);
        Ember.TEMPLATES['metric_add_custom/html'] = Ember.Handlebars.compile(arguments[32]);
        Ember.TEMPLATES['metric_node/html'] = Ember.Handlebars.compile(arguments[33]);
        Ember.TEMPLATES['monitoring/html'] = Ember.Handlebars.compile(arguments[34]);
