  ...
  return function (callback) {
    if (!JS_BUILD) {
      require([
        ...
        Ember.TEMPLATES['key'] = Ember.Handlebars.compile(arguments[15]);
        Ember.TEMPLATES['key_add'] = Ember.Handlebars.compile(arguments[16]);
        Ember.TEMPLATES['key_edit'] = Ember.Handlebars.compile(arguments[17]);
        ...
        Ember.TEMPLATES['login'] = Ember.Handlebars.compile(arguments[22]);
        Ember.TEMPLATES['machine'] = Ember.Handlebars.compile(arguments[23]);
        Ember.TEMPLATES['machine_add'] = Ember.Handlebars.compile(arguments[24]);
        Ember.TEMPLATES['machine_edit'] = Ember.Handlebars.compile(arguments[25]);
        Ember.TEMPLATES['machine_keys'] = Ember.Handlebars.compile(arguments[26]);
        Ember.TEMPLATES['machine_keys_list_item'] = Ember.Handlebars.compile(arguments[27]);
        Ember.TEMPLATES['machine_list'] = Ember.Handlebars.compile(arguments[28]);
        Ember.TEMPLATES['machine_list_item'] = Ember.Handlebars.compile(arguments[29]);
        Ember.TEMPLATES['machine_monitoring'] = Ember.Handlebars.compile(arguments[30]);
        Ember.TEMPLATES['machine_power'] = Ember.Handlebars.compile(arguments[31]);
        Ember.TEMPLATES['machine_shell'] = Ember.Handlebars.compile(arguments[32]);
        Ember.TEMPLATES['machine_tags'] = Ember.Handlebars.compile(arguments[33]);
        Ember.TEMPLATES['machine_tags_list_item'] = Ember.Handlebars.compile(arguments[34]);
        Ember.TEMPLATES['messagebox'] = Ember.Handlebars.compile(arguments[35]);
        Ember.TEMPLATES['metric_add'] = Ember.Handlebars.compile(arguments[36]);
        Ember.TEMPLATES['metric_add_custom'] = Ember.Handlebars.compile(arguments[37]);
        Ember.TEMPLATES['metric_node'] = Ember.Handlebars.compile(arguments[38]);
        Ember.TEMPLATES['missing'] = Ember.Handlebars.compile(arguments[39]);
        Ember.TEMPLATES['network'] = Ember.Handlebars.compile(arguments[40]);
        Ember.TEMPLATES['network_create'] = Ember.Handlebars.compile(arguments[41]);
        Ember.TEMPLATES['network_list'] = Ember.Handlebars.compile(arguments[42]);
        Ember.TEMPLATES['network_list_item'] = Ember.Handlebars.compile(arguments[43]);
        Ember.TEMPLATES['rule'] = Ember.Handlebars.compile(arguments[44]);
        Ember.TEMPLATES['rule_edit'] = Ember.Handlebars.compile(arguments[45]);
        Ember.TEMPLATES['rule_list'] = Ember.Handlebars.compile(arguments[46]);
        Ember.TEMPLATES['script'] = Ember.Handlebars.compile(arguments[47]);
        Ember.TEMPLATES['script_add'] = Ember.Handlebars.compile(arguments[48]);
        Ember.TEMPLATES['script_edit'] = Ember.Handlebars.compile(arguments[49]);
        Ember.TEMPLATES['script_list'] = Ember.Handlebars.compile(arguments[50]);
        Ember.TEMPLATES['script_list_item'] = Ember.Handlebars.compile(arguments[51]);
        Ember.TEMPLATES['script_log_list'] = Ember.Handlebars.compile(arguments[52]);
        Ember.TEMPLATES['script_run'] = Ember.Handlebars.compile(arguments[53]);
        Ember.TEMPLATES['subnet_list_item'] = Ember.Handlebars.compile(arguments[54]);
        Ember.TEMPLATES['user_menu'] = Ember.Handlebars.compile(arguments[55]);
        callback();
      });
      return;
    }
