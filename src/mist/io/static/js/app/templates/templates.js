  ...
  return function (callback) {
    if (!JS_BUILD) {
      require([
        ...
        Ember.TEMPLATES['graph_list_item/html'] = Ember.Handlebars.compile(arguments[9]);
        Ember.TEMPLATES['home/html'] = Ember.Handlebars.compile(arguments[10]);
        Ember.TEMPLATES['image_list/html'] = Ember.Handlebars.compile(arguments[11]);
        Ember.TEMPLATES['image_list_item/html'] = Ember.Handlebars.compile(arguments[12]);
        Ember.TEMPLATES['key/html'] = Ember.Handlebars.compile(arguments[13]);
        ...
        Ember.TEMPLATES['key_list/html'] = Ember.Handlebars.compile(arguments[16]);
        Ember.TEMPLATES['key_list_item/html'] = Ember.Handlebars.compile(arguments[17]);
        Ember.TEMPLATES['login/html'] = Ember.Handlebars.compile(arguments[18]);
        Ember.TEMPLATES['machine/html'] = Ember.Handlebars.compile(arguments[19]);
        Ember.TEMPLATES['machine_add/html'] = Ember.Handlebars.compile(arguments[20]);
        Ember.TEMPLATES['machine_keys/html'] = Ember.Handlebars.compile(arguments[21]);
        Ember.TEMPLATES['machine_keys_list_item/html'] = Ember.Handlebars.compile(arguments[22]);
        Ember.TEMPLATES['machine_list/html'] = Ember.Handlebars.compile(arguments[23]);
        Ember.TEMPLATES['machine_list_item/html'] = Ember.Handlebars.compile(arguments[24]);
        Ember.TEMPLATES['machine_manual_monitoring/html'] = Ember.Handlebars.compile(arguments[25]);
        Ember.TEMPLATES['machine_power/html'] = Ember.Handlebars.compile(arguments[26]);
        Ember.TEMPLATES['machine_shell/html'] = Ember.Handlebars.compile(arguments[27]);
        Ember.TEMPLATES['machine_shell_list_item/html'] = Ember.Handlebars.compile(arguments[28]);
        ...
        Ember.TEMPLATES['monitoring/html'] = Ember.Handlebars.compile(arguments[35]);
