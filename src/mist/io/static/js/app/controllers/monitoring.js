    ...
    function(Graph, Metric) {
        ...
        return Ember.Object.extend(Ember.Evented, {
            ...
            _updateMonitoringData: function(data) {
                ...
                // "machines" field will be removed eventually
                ...
                // Inject monitoring status on machine
                forIn(this, data.monitored_machines, function (machineDict, uuid) {
                    var machine = Mist.backendsController.getMachine(
                        machineDict.machine_id, machineDict.backend_id);
                    ...
                    if (machine)
                        forIn(machineDict.installation_status, function (value, property) {
                            if (property != 'state')
                                ...
                                machine.set('installation_state', value);
                        });
                })
