...
Feature: Backends
    ...
    Scenario: Add Backend
        ...
        And I wait for 1 seconds
            Then I should see the "EC2 AP SOUTHEAST" Backend added within 60 seconds


    @web
    Scenario: Disable Backend
        When I click the "EC2 AP SOUTHEAST" button
        And I wait for 1 seconds
        When I flip the backend switch
        And I wait for 1 seconds
        And I click the "Back" button
        And I wait for 5 seconds
            Then "EC2 AP SOUTHEAST" backend should be "offline"
    ...
    Scenario: Enable Backend
        ...
        And I click the "Back" button
        And I wait for 5 seconds
            Then "EC2 AP SOUTHEAST" backend should be "online"
