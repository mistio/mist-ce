...
Feature: Add second-tier backends
  ...
  Scenario Outline:
    ...
    And I expect for "add-backend" panel to appear within max 1 seconds
...
#    | Docker                | DOCKER       |
  ...
  Scenario: Backend Actions
    ...
    And I expect for "backend-edit-popup" popup to appear within max 1 seconds
    And I click the "_x_" button inside the "Edit cloud" popup
    And I expect for "backend-edit-popup" popup to disappear within max 1 seconds
